...
public class QMRPrivateGenerate {

	@Test
	public void QMRPrivate() throws InterruptedException {
		...
		System.out.println("Total time taken on PW to generate QMR for "+planId+" is "+timeInMinutes+ " minute and "+timeInSeconds+" seconds");		
		driver.quit();
	}
}
